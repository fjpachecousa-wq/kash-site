...
{showConfirmModal && (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-xl w-[92%]">
      <div className="flex items-start justify-between">
        <h3 className="text-lg font-semibold">Dados enviados com sucesso</h3>
        <button type="button" className="text-sm text-gray-500 hover:text-gray-700" onClick={()=>setShowConfirmModal(false)} aria-label="Fechar">
          Fechar
        </button>
      </div>

      <p className="mt-3 text-sm text-gray-700">Seu código de acompanhamento (tracking):</p>
      <div className="mt-2 p-2 bg-gray-100 rounded border text-center font-mono text-base">
        {confirmTracking || _readTrackingCode() || "KASH-XXXXXX"}
      </div>

      <div className="mt-4 p-3 rounded bg-yellow-50 border text-sm text-yellow-900">
        <strong>Aguarde confirmação</strong>
      </div>
